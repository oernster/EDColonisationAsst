...
then chains to the default handler, so behaviour is otherwise unchanged.

The log lives under the temporary directory rather than beside the executable,
because the executable frequently sits somewhere the user cannot write to.
